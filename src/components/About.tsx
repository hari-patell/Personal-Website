        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-10 mt-10 md:mt-14">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4 p-5 rounded-xl bg-white/60 dark:bg-stone-800/50 border border-stone-200/60 dark:border-stone-600/50 transition-all duration-300 hover:bg-white dark:hover:bg-stone-700/60 hover:shadow-sm hover:border-stone-300/60 dark:hover:border-stone-500/50">
                <Code2 className="w-5 h-5 text-stone-500 dark:text-cream-300 mt-0.5 flex-shrink-0" />
                <div>
                  <h3 className="font-serif font-semibold text-stone-900 dark:text-cream-100 mb-1">Clean Code</h3>
                  <p className="text-stone-500 dark:text-cream-200/90 text-sm leading-relaxed">
                    Writing maintainable, scalable, and well-documented code
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4 p-5 rounded-xl bg-white/60 dark:bg-stone-800/50 border border-stone-200/60 dark:border-stone-600/50 transition-all duration-300 hover:bg-white dark:hover:bg-stone-700/60 hover:shadow-sm hover:border-stone-300/60 dark:hover:border-stone-500/50">
                <Rocket className="w-5 h-5 text-stone-500 dark:text-cream-300 mt-0.5 flex-shrink-0" />
                <div>
                  <h3 className="font-serif font-semibold text-stone-900 dark:text-cream-100 mb-1">Performance</h3>
                  <p className="text-stone-500 dark:text-cream-200/90 text-sm leading-relaxed">
              ...
              <div className="flex items-start gap-4 p-5 rounded-xl bg-white/60 dark:bg-stone-800/50 border border-stone-200/60 dark:border-stone-600/50 transition-all duration-300 hover:bg-white dark:hover:bg-stone-700/60 hover:shadow-sm hover:border-stone-300/60 dark:hover:border-stone-500/50">
                <Target className="w-5 h-5 text-stone-500 dark:text-cream-300 mt-0.5 flex-shrink-0" />
                <div>
                  <h3 className="font-serif font-semibold text-stone-900 dark:text-cream-100 mb-1">Problem Solving</h3>
                  <p className="text-stone-500 dark:text-cream-200/90 text-sm leading-relaxed">
              ...
              <div className="flex items-start gap-4 p-5 rounded-xl bg-white/60 dark:bg-stone-800/50 border border-stone-200/60 dark:border-stone-600/50 transition-all duration-300 hover:bg-white dark:hover:bg-stone-700/60 hover:shadow-sm hover:border-stone-300/60 dark:hover:border-stone-500/50">
                <Heart className="w-5 h-5 text-stone-500 dark:text-cream-300 mt-0.5 flex-shrink-0" />
                <div>
                  <h3 className="font-serif font-semibold text-stone-900 dark:text-cream-100 mb-1">Passion</h3>
                  <p className="text-stone-500 dark:text-cream-200/90 text-sm leading-relaxed">
